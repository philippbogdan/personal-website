---
title: 'Chasing proxies - the role of taste in goal attainment'
...
Well, the problem is that all the cheap workers were immigrants and none of them spoke enough English to actually be helpful on the call. And the mattresses - the core product of the company - are dogshit quality, because the owner spent all his time optimising for a proxy as the main goal, rather than focusing on the product.
